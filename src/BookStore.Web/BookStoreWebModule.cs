...
public class BookStoreWebModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        ...
        if (!hostingEnvironment.IsDevelopment())
        {
            ...
            {
                serverBuilder.AddProductionEncryptionAndSigningCertificate("openiddict.pfx", "87a99ee8-c956-4406-92ff-e70883fbfd5f");
    ...
    private void ConfigureVirtualFileSystem(IWebHostEnvironment hostingEnvironment)
    {
        Configure<AbpVirtualFileSystemOptions>(options =>
        {
            ...
            if (hostingEnvironment.IsDevelopment())
            {
                ...
                options.FileSets.ReplaceEmbeddedByPhysical<BookStoreHttpApiModule>(Path.Combine(hostingEnvironment.ContentRootPath, string.Format("..{0}..{0}src{0}BookStore.HttpApi", Path.DirectorySeparatorChar)));
