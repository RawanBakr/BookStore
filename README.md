...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 87a99ee8-c956-4406-92ff-e70883fbfd5f
```

> `87a99ee8-c956-4406-92ff-e70883fbfd5f` is the password of the certificate, you can change it to any password you want.
